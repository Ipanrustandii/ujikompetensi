<body>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p class="text-center text-muted mb-4">Perbarui informasi produk</p>
            ...
            <div class="card form-card">
                <form action="../../backend/querySql/updateProduk.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 position-relative">
                        ...
                        <input type="text" class="form-control" id="namaProduk" name="nama_produk" value="<?= htmlspecialchars($data['nama_produk']) ?>" required />
                    </div>

                    <div class="mb-3 position-relative">
                        <label for="harga" class="form-label">Harga</label>
                        <i class="bi bi-cash-stack input-icon"></i>
                        <input type="number" class="form-control" id="harga" name="harga" value="<?= htmlspecialchars($data['harga']) ?>" min="1" required />
                    </div>

                    <div class="mb-3 position-relative">
                        <label for="stok" class="form-label">Stok</label>
                        <i class="bi bi-box-seam input-icon"></i>
                        <input type="number" class="form-control" id="stok" name="stok" value="<?= htmlspecialchars($data['stok']) ?>" min="1" required />
                    </div>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <button type="submit" class="btn btn-update" name="update" onclick="return confirm('Apakah Anda yakin ingin mengubah data ini?')">
